                    ...
                    ?>
                            ...
                            <tbody class="text-gray-600">
                                    <?php
                                        ...
                                        $select = "
                                        SELECT Product.ID, srstocpri.DateAndTime, srstocpri.Checking, product.PName, product.Title, product.Spec, product.image, product.Desc, product.UniqueC 
                                        FROM srstocpri
                                        INNER JOIN product ON srstocpri.ProductID=product.ID
                                        WHERE srstocpri.Status='1' AND product.UniqueC='$_GET[Code]';
                                        ";
