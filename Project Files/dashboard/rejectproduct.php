                        ...
                        ?>
                            ...
                            <tbody class="text-gray-600">
                                <?php
                                    ...
                                    $select = "SELECT * FROM `product` WHERE `UserID`='$_SESSION[ID]' AND `Status`='1' AND `Checking`='2' AND `UniqueC`='$_GET[Code]'";
                        ...
                        ?>
                                ...
                                <tbody class="text-gray-600">
                                        <?php
                                            ...
                                            $select = "SELECT * FROM `product` WHERE `UserID`='$_SESSION[ID]' AND `Status`='1' AND `Checking`='2'";
