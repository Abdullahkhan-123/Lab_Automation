                    ...
                    if(isset($_GET['Code']))
                    {
                                ...
                                <tbody class="text-gray-600">
                                    <?php
                                        ...
                                        $select = "
                                            SELECT Product.ID, product.PName, product.PName, product.Title,product.Spec, product.image, product.Desc,  srstocpri.DateAndTime, srstocpri.UniqueC, srstocpri.Checking
                                            FROM srstocpri
                                            INNER JOIN product ON product.ID=srstocpri.ProductID 
                                            WHERE srstocpri.UniqueC='$_GET[Code]'
                                        ...
                                        while($row = mysqli_fetch_assoc($run))
                                            ...
                                            {
                                                ?>
                                                    <tr id="tr" onclick="window.location.href='productdetail.php?ID=<?php echo $ID ?>'">                                 
                                            ...
                                            {
                                                ?>
                                                    <tr onclick="window.location.href='productdetail.php?ID=<?php echo $ID ?>'">                                 
                                                        <td class="border border-l-0 px-4 py-2"><?php echo $No++ ?></td>
                                                        <td class="border border-l-0 px-4 py-2"><?php echo $Product ?></td>
                                                        <td class="border border-l-0 px-4 py-2">
                                                            <img src="<?php echo $productimg,$image ?>" style="height:90px; width:150px; margin:auto;">                                    
